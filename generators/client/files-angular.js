    ...
    angularShared: [
        {
            ...
            templates: [
                ...
                'shared/component/panel/panel.component.html',
                'shared/component/panel/panel.component.ts',
                'shared/component/panel/panel.module.ts',
                //export
                'shared/component/export/export-controls.component.html',
                'shared/component/export/export-controls.component.ts',
                'shared/component/export/export-format.model.ts',
                'shared/component/export/export-type.ts',
                'shared/component/export/export.module.ts',
                'shared/component/export/index.ts',
                //toaster
                'shared/component/toaster/index.ts',
                'shared/component/toaster/toaster.animation.ts',
                'shared/component/toaster/toaster.component.html',
                'shared/component/toaster/toaster.component.scss',
                'shared/component/toaster/toaster.component.ts',
                'shared/component/toaster/toaster.model.ts',
                'shared/component/toaster/toaster.module.ts',
